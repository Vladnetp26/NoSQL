...
# Парсинг XML
file = '/food_display_table.xml'
factory = XMLInputFactory.newInstance
reader = factory.createXMLStreamReader(FileInputStream.new(file))
...
puts "Starting import from #{file}..."
...
# Проверка: запрос любимых продуктов питания
puts "Querying for Apple (Code 12345)..."
get 'foods', '12345'
